...
func configureAPI(api *operations.AlertmanagerAPI) http.Handler {
	...
	api.AlertgroupsGetAlertGroupsHandler = alertgroups.GetAlertGroupsHandlerFunc(func(params alertgroups.GetAlertGroupsParams) middleware.Responder {
		return middleware.NotImplemented("operation alertgroups.GetAlertGroups has not yet been implemented")
	})
